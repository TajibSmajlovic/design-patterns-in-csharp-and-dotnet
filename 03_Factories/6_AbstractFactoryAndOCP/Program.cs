...
namespace _6_AbstractFactoryAndOCP
{
    ...
    public class HotDrinkMachine
    {
        ...
        private List<(string, IHotDrinkFactory)> namedFactories =
      new List<(string, IHotDrinkFactory)>();
        ...
        public HotDrinkMachine()
        {
            foreach (var t in typeof(HotDrinkMachine).Assembly.GetTypes())
            {
                ...
                {
                    namedFactories.Add((t.Name.Replace("Factory", string.Empty), (IHotDrinkFactory)Activator.CreateInstance(t)));
                }
            }
        }
